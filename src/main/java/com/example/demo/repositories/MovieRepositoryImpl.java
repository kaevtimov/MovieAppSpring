...
public class MovieRepositoryImpl implements MovieRepository {
    ...
    private void loadMovies() {
        movies.add(new Movie(this.generator.getNextId(), 63, 15,"Lethal weapon", "Action/thriller", 1987, 110, "https://ewedit.files.wordpress.com/2015/01/lethal-weapon.jpg", "Lethal Weapon is a 1987 American buddy cop action comedy film directed by Richard Donner, " +
        ...
        movies.add(new Movie(this.generator.getNextId(), 78, 20, "Die hard", "Action/thriller", 1988, 132, "https://cdn-images-1.medium.com/max/1000/1*j12cZpY7JomaSH_ZRuiDdg.png", "Die Hard is a 1988 American action thriller[2] film directed by John McTiernan and written by Steven E. " +
        ...
        movies.add(new Movie(this.generator.getNextId(), 70, 14, "Beverly Hills Cop", "Action/comedy", 1984, 105, "https://i0.wp.com/www.projectcasting.com/wp-content/uploads/2015/05/beverly-hills-cop.jpg?fit=618%2C412", "Beverly Hills Cop is a 1984 American action comedy film directed by Martin Brest, written by Daniel Petrie Jr. " +
        ...
        movies.add(new Movie(this.generator.getNextId(), 81, 18, "The Librarian: Quest for the Spear", "Action/thriller/adventure", 2004, 90, "https://fanart.tv/fanart/movies/14207/moviethumb/the-librarian-quest-for-the-spear-58ba898addbba.jpg","Flynn Carsen (Noah Wyle), a perpetual college student with 22 academic degrees,[1] is kicked out " +
        ...
        movies.add(new Movie(this.generator.getNextId(), 81.7, 19, "Titanic", "Drama", 1997, 195, "https://rmstitanichotel.co.uk/wp-content/uploads/2017/07/Rose-and-Jack-Movie-poster.jpg","Titanic is a 1997 American epic romance and disaster film directed, written, co-produced and co-edited by James Cameron. A fictionalized account of the sinking of the " +
        ...
        movies.add(new Movie(this.generator.getNextId(), 78, 20, "Air Force One", "Action/thriller", 1997, 126, "http://1.bp.blogspot.com/-UHXC1ChdE6Q/VAJJ7259UeI/AAAAAAAAEJo/WC3kgvwOnwU/s1600/max1331375232-front-cover.jpg","Air Force One is a 1997 American political action-thriller film written by Andrew W. Marlowe, and directed and co-produced by Wolfgang Petersen. " +
        ...
        movies.add(new Movie(this.generator.getNextId(), 63, 15, "The Lion King", "Animation/drama", 1994, 88, "https://steamcdn-a.akamaihd.net/steam/apps/561120/header.jpg?t=1513876929","The Lion King is a 1994 American animated epic musical film produced by Walt Disney Feature Animation and released by Walt Disney Pictures." +
        ...
        movies.add(new Movie(this.generator.getNextId(), 70, 14, "Interstellar", "Action/thriller/fantastic/sci-fi", 2014, 169, "https://www.legendarytrips.com/wp-content/uploads/Interstellar_2014.jpg","Interstellar is a 2014 science fiction film directed, co-written, and co-produced by Christopher Nolan. It stars Matthew McConaughey, Anne Hathaway, Jessica Chastain, Bill Irwin, " +
        ...
        movies.add(new Movie(this.generator.getNextId(), 81, 18, "Jumanji", "Comedy/adventure", 1995, 104, "https://lh3.googleusercontent.com/oitmveeHup9us_Dm9V0qjcNJgr9StFBhro61917sKuDs8qnTamoy0w01xMc2zO8chjpotlNdG0_D","Jumanji is a 1995 American fantasy adventure film directed by Joe Johnston. It is an adaptation of the 1981 children's book of the same name by Chris Van Allsburg. The film was written" +
        ...
        movies.add(new Movie(this.generator.getNextId(), 63, 15, "Star Wars: Episode I – The Phantom Menace", "Action/thriller/sci-fi", 1999, 133, "http://4.bp.blogspot.com/-Su0VnEjHXdc/U3RHnUFDSrI/AAAAAAAALGg/wMZXaKEaZ7U/s1600/237934.jpg", "Star Wars: Episode I – The Phantom Menace is a 1999 American epic space opera written and directed by George Lucas, produced by Lucasfilm and " +
        ...
        movies.add(new Movie(this.generator.getNextId(), 78, 20, "Finding Nemo", "Comedy/family", 2003, 100, "https://cdn-images-1.medium.com/max/1600/1*Pg5wWwVLIS-X0dpMuwWzEw.jpeg", "Finding Nemo is a 2003 American computer-animated adventure film produced by Pixar Animation Studios and released by Walt Disney Pictures. Written and directed by Andrew Stanton " +
        ...
        movies.add(new Movie(this.generator.getNextId(), 70, 14, "Forrest Gump", "Adventure/comedy/drama", 1994, 142, "https://cafebiz.cafebizcdn.vn/thumb_w/600/2015/tom-1441182009908.jpg", "Forrest Gump is a 1994 American romantic comedy-drama film based on Winston Groom’s 1986 novel of the same name. It was directed by Robert Zemeckis and written by Eric Roth, " +
        ...
        movies.add(new Movie(this.generator.getNextId(), 78, 20, "The Mask", "Action/comedy", 1994, 101, "https://i.ytimg.com/vi/YRAImdAcl5g/maxresdefault.jpg", "The Mask is a 1994 American dark fantasy superhero comedy film directed by Charles Russell, produced by Bob Engelman, and written by Mike Werb, based on the comic series of " +
        ...
        movies.add(new Movie(this.generator.getNextId(), 63, 15, "Space Jam", "Animation/comedy/sport", 1996, 88, "https://vignette.wikia.nocookie.net/siivagunner/images/3/3d/GET_READY_TO_JAM.jpg/revision/latest?cb=20160812154030", "Space Jam is a 1996 American live-action/animated sports comedy film starring basketball player Michael Jordan and featuring the Looney Tunes cartoon characters. The film was " +
        ...
        movies.add(new Movie(this.generator.getNextId(), 63, 15, "Tombstone", "Action/thriller/western", 1993, 144, "https://s22658.pcdn.co/wp-content/uploads/2016/08/F_Reel_WEB_Tombstone-Val-Kilmer-Sam-Elliott-Bill-Paxton-Kurt-Russell_scaled.jpg", "Tombstone is a 1993 American Western film directed by George P. Cosmatos, written by Kevin Jarre (who was also the original director, but was replaced early in production)," +
        ...
        movies.add(new Movie(this.generator.getNextId(), 78, 20, "The hangover", "Comedy", 2009, 100, "https://www.vintagemovieposters.co.uk/wp-content/uploads/2015/07/hangoverquadlarge1.jpg", "The Hangover is a 2009 American comedy film directed by Todd Phillips, co-produced with Daniel Goldberg, and written by Jon Lucas and Scott Moore. " +
