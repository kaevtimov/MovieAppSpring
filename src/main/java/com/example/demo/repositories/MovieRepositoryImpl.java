...
public class MovieRepositoryImpl implements MovieRepository {
    ...
    private void loadMovies() {
        movies.add(new Movie(this.generator.getNextId(), "Lethal weapon", "Action/thriller", 1987, 0, 110, null, "Lethal Weapon is a 1987 American buddy cop action comedy film directed by Richard Donner, " +
        ...
        movies.add(new Movie(this.generator.getNextId(), "Die hard", "Action/thriller", 1988, 0, 132, null, "Die Hard is a 1988 American action thriller[2] film directed by John McTiernan and written by Steven E. " +
        ...
        movies.add(new Movie(this.generator.getNextId(), "Beverly Hills Cop", "Action/comedy", 1984, 0, 105, null, "Beverly Hills Cop is a 1984 American action comedy film directed by Martin Brest, written by Daniel Petrie Jr. " +
        ...
        movies.add(new Movie(this.generator.getNextId(), "The Librarian: Quest for the Spear", "Action/thriller/adventure", 2004, 0, 90, null,"Flynn Carsen (Noah Wyle), a perpetual college student with 22 academic degrees,[1] is kicked out " +
        ...
        movies.add(new Movie(this.generator.getNextId(), "Titanic", "Drama", 1997, 0, 195, null,"Titanic is a 1997 American epic romance and disaster film directed, written, co-produced and co-edited by James Cameron. A fictionalized account of the sinking of the " +
        ...
        movies.add(new Movie(this.generator.getNextId(), "Air Force One", "Action/thriller", 1997, 0, 126, null,"Air Force One is a 1997 American political action-thriller film written by Andrew W. Marlowe, and directed and co-produced by Wolfgang Petersen. " +
        ...
        movies.add(new Movie(this.generator.getNextId(), "The Lion King", "Animation/drama", 1994, 0, 88, null,"The Lion King is a 1994 American animated epic musical film produced by Walt Disney Feature Animation and released by Walt Disney Pictures." +
        ...
        movies.add(new Movie(this.generator.getNextId(), "Braveheart", "Action/thriller/historical", 1995, 0, 178, null, "Braveheart is a 1995 American epic war film directed by Mel Gibson, who stars as William Wallace, a late 13th-century Scottish warrior who led the " +
        ...
        movies.add(new Movie(this.generator.getNextId(), "Interstellar", "Action/thriller/fantastic/sci-fi", 2014, 0, 169, null,"Interstellar is a 2014 science fiction film directed, co-written, and co-produced by Christopher Nolan. It stars Matthew McConaughey, Anne Hathaway, Jessica Chastain, Bill Irwin, " +
        ...
        movies.add(new Movie(this.generator.getNextId(), "Jumanji", "Comedy/adventure", 1995, 0, 104, null,"Jumanji is a 1995 American fantasy adventure film directed by Joe Johnston. It is an adaptation of the 1981 children's book of the same name by Chris Van Allsburg. The film was written" +
        ...
        movies.add(new Movie(this.generator.getNextId(), "Star Wars: Episode I – The Phantom Menace", "Action/thriller/sci-fi", 1999, 0, 133, null, "Star Wars: Episode I – The Phantom Menace is a 1999 American epic space opera written and directed by George Lucas, produced by Lucasfilm and " +
        ...
        movies.add(new Movie(this.generator.getNextId(), "Finding Nemo", "Comedy/family", 2003, 0, 100, null, "Finding Nemo is a 2003 American computer-animated adventure film produced by Pixar Animation Studios and released by Walt Disney Pictures. Written and directed by Andrew Stanton " +
        ...
        movies.add(new Movie(this.generator.getNextId(), "Forrest Gump", "Adventure/comedy/drama", 1994, 0, 142, null, "Forrest Gump is a 1994 American romantic comedy-drama film based on Winston Groom’s 1986 novel of the same name. It was directed by Robert Zemeckis and written by Eric Roth, " +
        ...
        movies.add(new Movie(this.generator.getNextId(), "The Mask", "Action/comedy", 1994, 0, 101, null, "The Mask is a 1994 American dark fantasy superhero comedy film directed by Charles Russell, produced by Bob Engelman, and written by Mike Werb, based on the comic series of " +
        ...
        movies.add(new Movie(this.generator.getNextId(), "The Da Vinci Code", "Mysterious/thriller", 2006,0, 149, null, "The Da Vinci Code is a 2006 American mystery thriller film directed by Ron Howard, written by Akiva Goldsman, and based on Dan Brown's 2003 best-selling novel of the same name. " +
        ...
        movies.add(new Movie(this.generator.getNextId(), "Space Jam", "Animation/comedy/sport", 1996, 0, 88, null, "Space Jam is a 1996 American live-action/animated sports comedy film starring basketball player Michael Jordan and featuring the Looney Tunes cartoon characters. The film was " +
        ...
        movies.add(new Movie(this.generator.getNextId(), "Goodfellas", "Action/thriller", 1990, 0, 145, null, "Goodfellas (stylized as GoodFellas) is a 1990 American crime film directed by Martin Scorsese. It is an adaptation of the 1986 non-fiction book Wiseguy by Nicholas Pileggi, " +
        ...
        movies.add(new Movie(this.generator.getNextId(), "Heat", "Action/thriller", 1995, 0, 170, null, "Heat is a 1995 American crime film written, co-produced and directed by Michael Mann, and starring Al Pacino, Robert De Niro and Val Kilmer. De Niro plays Neil McCauley, " +
        ...
        movies.add(new Movie(this.generator.getNextId(), "Tombstone", "Action/thriller/western", 1993, 0, 144, null, "Tombstone is a 1993 American Western film directed by George P. Cosmatos, written by Kevin Jarre (who was also the original director, but was replaced early in production)," +
        ...
        movies.add(new Movie(this.generator.getNextId(), "The hangover", "Comedy", 2009, 0, 100, null, "The Hangover is a 2009 American comedy film directed by Todd Phillips, co-produced with Daniel Goldberg, and written by Jon Lucas and Scott Moore. " +
